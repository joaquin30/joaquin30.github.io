...
rm post/*.html
header=$(pandoc --css=styling.css -V lang=es -V highlighting-css= --mathjax --to=html5 src/header.md)
header=${header::-15}
footer=$"</body>\n</html>"
for file in src/md/*
do
	...
	pandoc --css=styling.css -V lang=es -V highlighting-css= --mathjax --to=html5 "$file" -o "post/${aux}.html"
done
